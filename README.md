# :snake: Data Handling 1 - DataFrames - Part 1

Welcome to the Data Handling part of L2D course. Congratulations on successfully completeing Basic Python part.
...
- [Data Frames - Part 1](https://l2d-july2024-part-i.github.io/Data_Handling/01-data_frames_1.html)
...
The live lecture for this lesson will take place on **Thursday 12th of September at 14:00 BST, on Zoom**. The Jupyter Notebook file used during this lecture can be accessed from the folder [Lecture_Resources](./Lecture_Resources) in this GitHub Repository. 
...
Note: A recording of this lesson's Live Lecture (Data Handling 1 - DataFrames - Part 1) will be posted on the [Discussion Forum](https://github.com/orgs/L2D-July2024-Part-I/discussions), shortly after it has been streamed. 
